<footer class="py-16 sm:py-20 md:py-24 px-4 md:px-8">
  <div
    class="max-w-[1200px] mx-auto w-full grid grid-cols-1 sm:grid-cols-2
  md:grid-cols-5 gap-8 text-base"
  >
    <div class="flex flex-col gap-4 md:col-span-2">
      <h1 class="font-semibold">
        Bas<span class="text-indigo-400">ket</span>
      </h1>
      <p>2023 Basket LTD. all rights reserved</p>
    </div>
